Shader "VR/SpatialMapping/Wireframe_Transparent"
{
	Properties
	{
		_WireThickness("Wire Thickness", RANGE(0, 800)) = 100
		_WireTransparency("Wire Transparency", RANGE(0, 1)) = 0.3
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (g2f i) : SV_Target
			{
				...
				fixed4 finalColor = lerp(float4(0,0,0,1), wireColor, t) * _WireTransparency;
				finalColor.a = t * _WireTransparency;
